...
" Enable 'old' (non-treesitter) syntax parsing for highlights and some plugins
" TODO: What needs this? Was it that I disliked the treesitter colors?
" Possibly nvim-autopairs depended on this, but it has been configured to use treesitter now.
syntax on
