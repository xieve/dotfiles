{ ... }:
{
  services = {
    lldap = {
      ...
      environment = {
        LLDAP_LDAP_USER_PASS_FILE = "%d/LLDAP_LDAP_USER_PASS_FILE";
      };
    };
  };
  systemd.services.lldap.serviceConfig.SetCredentialEncrypted = [
    ...
    "LLDAP_LDAP_USER_PASS_FILE:Whxqht+dQJax1aZeCGLxmiAAAAABAAAADAAAABAAAABPNxRtnQ2PRQ7YpQ0AAAAABmljYVdOKTBqa3zTlcFa+oaPP6oT8FjQWaqt06Ev5p5nyq83rA2nzOXzU5ikMu4HuDWEjojg0JahMvfcM6nSpvv7PEj/kxvB77vKhWDZ9K6qnkSZFUeUe+JZequL5aOLQ2O3D9uZawtQAmhvGm2ekg=="
  ];
}
